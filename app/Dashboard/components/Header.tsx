...
export default function Header() {
  ...
  return (
    <header className="
      ...
      h-16 px-6 bg-white border-b border-slate-200/80
    ...
    ">
      ...
      <div className="flex items-center gap-2">
        ...
        {/* User profile */}
        <button className="flex items-center gap-2.5 pl-1 pr-2 py-1.5 rounded-xl hover:bg-slate-50 transition-all duration-150 group">
          {/* Avatar */}
          <div className={`w-8 h-8 rounded-xl flex items-center justify-center text-[12px] font-bold text-white flex-shrink-0 ${meta.avatarBg} shadow-sm`}>
            {initials}
          </div>
