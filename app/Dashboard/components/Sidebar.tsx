...
const MENU_BY_ROLE: Record<UserRole, any[]> = {
  ...
  [UserRole.MARKETING_MANAGER]: [
    { href: "/Dashboard", label: "Dashboard", icon: LayoutDashboard },
    { href: "/Dashboard/marketing", label: "Dashboard", icon: LayoutDashboard },
  ],
  ...
  [UserRole.HR_MANAGER]: [
    { href: "/Dashboard/RH/postslist", label: "post list", icon: LayoutDashboard },
    { href: "/Dashboard/RH/postslist/create", label: "add post", icon: UserPlus },
    { href: "/Dashboard/users/create", label: "Ajouter utilisateur", icon: UserPlus },
    { href: "/Dashboard/users", label: "Utilisateurs", icon: Users },
  ],
  ...
  [UserRole.COMMERCIAL]: [
    ...
    <span className="relative inline-flex w-6 h-6">
      ...
      { href: "/Dashboard/commerciale/recomandationindistry", label: "Chercher company",   icon: () => (
    <span className="relative inline-flex w-6 h-6">
      <Building className="w-6 h-6" />
      <Search className="w-3 h-3 absolute -right-0 -bottom-0 bg-white rounded-full p-0.5 text-blue-600" />
    </span>
